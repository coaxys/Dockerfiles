...
==================
```
sudo docker build -t coaxys/play-127 .
```
...
# -d : background
PLAY_ID=$(sudo docker run -v /var/docker/app:/app -p 9000:9000 -d coaxys/play-127 run /app --%prod)

sudo docker ps
ID                  IMAGE                   COMMAND                CREATED              STATUS              PORTS
2f7683a397e5        coaxys/play-127:latest  /opt/play/play-1.2.7   About a minute ago   Up About a minute   9000->9000
