...
==================
```
docker build -t coaxys/tomcat-6 .
```
...
# -d : background
TOMCAT8_ID=$(sudo docker run -v /var/docker/deploy:/deploy -p 8081:8080 -d coaxys/tomcat-6)

sudo docker ps
ID                  IMAGE                   COMMAND                CREATED              STATUS              PORTS
2f7683a397e5        coaxys/tomcat-6:latest  /opt/run.sh /bin/sh    About a minute ago   Up About a minute   8081->8080
