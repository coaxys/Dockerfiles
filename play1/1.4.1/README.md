...
==================
```
sudo docker build -t coaxys/play1:1.4.1 .
```

Utilisation du container
========================
```
sudo docker run -it --rm coaxys/play1:1.4.1
...
2f7683a397e5        coaxys/play1:1.4.1  /opt/play/play         About a minute ago   Up About a minute   9000->9000
